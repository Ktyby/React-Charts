...
(() => {
	var e = {
			...
			448: (e, t, n) => {
				...
				function na(e, t) {
					if (Zl !== e && !1 !== t && 0 !== t)
						if (
							...
							(Xl = t), (Yl.dependencies = { lanes: 0, firstContext: t, responders: null });
						} else Xl = Xl.next = t;
				...
				function no(e, t, n, r, l, a) {
					if (
						...
						do {
							...
							(a += 1), (Za = Xa = null), (t.updateQueue = null), (Qa.current = zo), (e = n(r, l));
						} while (Ja);
					}
					if (((Qa.current = No), (t = null !== Xa && null !== Xa.next), (Ka = 0), (Za = Xa = Ya = null), (Ga = !1), t))
						throw Error(o(300));
					return e;
				}
				function ro() {
					var e = { memoizedState: null, baseState: null, baseQueue: null, queue: null, next: null };
					return null === Za ? (Ya.memoizedState = Za = e) : (Za = Za.next = e), Za;
				}
				function lo() {
					if (null === Xa) {
						var e = Ya.alternate;
				...
				function bi(e, t) {
					for (;;) {
						...
						try {
							...
							if (((Ka = 0), (Za = Xa = Ya = null), (Ja = !1), (_u.current = null), null === n || null === n.return)) {
								(Ou = 1), (Ru = t), (Nu = null);
								break;
							}
							e: {
				...
				(Bu = function (e, t, n) {
					...
					(et = function (e) {
						13 === e.tag && (ii(e, 4, oi()), Zi(e, 4));
					}),
					(tt = function (e) {
						13 === e.tag && (ii(e, 67108864, oi()), Zi(e, 67108864));
					}),
					(nt = function (e) {
						if (13 === e.tag) {
							var t = oi(),
	...
	(n.n = (e) => {
		...
		(() => {
			...
			var i = (0, e.memo)(function (t) {
				var n = t.domain;
				return e.createElement(
					'div',
					{ className: 'chart__bottom-axis' },
					n.map(function (t, n) {
						return e.createElement('div', { className: 'chart__interval', key: n }, t);
					})
				);
			});
			(i.propTypes = { domain: l().arrayOf(l().string).isRequired }), (i.defaultProps = { domain: [] });
			const s = i;
			var c = n(19);
			o()(c.Z, { insert: 'head', singleton: !1 }), c.Z.locals;
			var f = (0, e.memo)(function (t) {
				var n = t.bars;
				return e.createElement(
					'div',
			...
			(f.propTypes = { bars: l().arrayOf(l().number).isRequired }), (f.defaultProps = { bars: [] });
			const d = f;
			var p = n(480);
			...
			(h.propTypes = { chartsData: l().arrayOf(l().object).isRequired }), (h.defaultProps = { chartsData: [] });
			const m = h;
			var v = n(456);
			o()(v.Z, { insert: 'head', singleton: !1 }), v.Z.locals;
			var g = [
				{ x: 'Germany', y: 91 },
				{ x: 'USA', y: 80 },
				{ x: 'Russia', y: 51 },
			...
			const y = function () {
				return e.createElement('div', { className: 'chart' }, e.createElement(m, { chartsData: g }));
			};
			t.render(e.createElement(y, null), document.querySelector('body'));
		})();
})();
